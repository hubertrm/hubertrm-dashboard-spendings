...
import be.hubertrm.dashboard.record.rest.spring.config.TestConfig;
...
class OrganisationBusinessManagerTest extends TestConfig {
    ...
    void givenElementExistsInDb_whenDeleting_shouldNotThrow() {
        ...
        Assertions.assertDoesNotThrow(() -> organisationBusinessManager.deleteOrganisationById(expectedOrganisationDto.getId()));
    }
