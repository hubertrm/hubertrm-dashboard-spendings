...
class OrganisationMapperTest {
    ...
    @Test
    void nullToOrganisationDto() throws ResourceNotFoundException {
    ...
    @Test
    void emptyToOrganisationDto() throws ResourceNotFoundException {
    ...
    @Test
    void organisationToOrganisationDto() throws ResourceNotFoundException {
