...
import be.hubertrm.dashboard.record.manager.GenericCategoryBusinessManager;
...
@WebMvcTest(GenericCategoryController.class)
class GenericCategoryControllerMockMvcWithContextTest {
    ...
    @MockBean
    private GenericCategoryBusinessManager categoryBusinessManager;
    ...
    void givenCategoryExists_whenRequestById_shouldReturnElement() throws Exception {
        // given
        given(categoryBusinessManager.getById(id)).willReturn(categoryDto);

        // when
        MockHttpServletResponse response =
                mvc.perform(get(String.format("/api/v1/genericCategory/%s", id)).accept(MediaType.APPLICATION_JSON))
    ...
    void givenCategoryDoesNotExist_whenRequestById_shouldReturnNotFoundException() throws Exception {
        // given
        given(categoryBusinessManager.getById(id)).willThrow(ResourceNotFoundException.class);

        // when
        MockHttpServletResponse response =
                mvc.perform(get(String.format("/api/v1/genericCategories/%s", id)).accept(MediaType.APPLICATION_JSON))
                        .andReturn().getResponse();
    ...
    void givenCategoryExists_whenRequestAll_shouldReturnSingletonList() throws Exception {
        // given
        given(categoryBusinessManager.getAll()).willReturn(Collections.singletonList(categoryDto));

        // when
        MockHttpServletResponse response =
                mvc.perform(get("/api/v1/genericCategories").accept(MediaType.APPLICATION_JSON))
                        .andReturn().getResponse();
    ...
    void givenMultipleCategoriesExist_whenRequestAll_shouldReturnList() throws Exception {
        ...
        // given
        given(categoryBusinessManager.getAll()).willReturn(Arrays.asList(categoryDto, category_2));
    ...
    void givenNoCategoryExists_whenRequestAll_shouldReturnEmptyList() throws Exception {
        // given
        given(categoryBusinessManager.getAll()).willReturn(Collections.emptyList());
    ...
    void givenCategoryDoesNotExist_whenRequestCreation_shouldReturnElement() throws Exception {
        ...
        // when
        MockHttpServletResponse response =
                mvc.perform(post("/api/v1/genericCategory")
    ...
    void givenCategoryExists_whenRequestUpdate_shouldReturnUpdatedElement() throws Exception {
        ...
        // when
        MockHttpServletResponse response =
                mvc.perform(put(String.format("/api/v1/genericCategory/%s", id))
                        .content(jsonCategory.write(categoryDto).getJson())
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON))
                        .andReturn().getResponse();
    ...
    void givenCategoryExists_whenDelete_shouldReturnDeletedMessage() throws Exception {
        ...
        // given
        given(categoryBusinessManager.deleteById(id)).willReturn(result);

        // when
        MockHttpServletResponse response =
                mvc.perform(delete(String.format("/api/v1/genericCategory/%s", id))
                        .accept(MediaType.APPLICATION_JSON))
                        .andReturn().getResponse();
    ...
    void givenCategoryDoesNotExist_whenDelete_shouldReturnNotFoundException() throws Exception {
        // given
        given(categoryBusinessManager.deleteById(id)).willThrow(ResourceNotFoundException.class);

        // when
        MockHttpServletResponse response =
                mvc.perform(delete(String.format("/api/v1/genericCategory/%s", id)).accept(MediaType.APPLICATION_JSON))
                        .andReturn().getResponse();
